 ...
 * @section An ascii question box is provided for each question, each question is multiple choice, the user is asked to input the number corresponding to the answer they choose and then confirm they
