...
//Use an if statement to determine if value x is even or odd, return true if it's even, odd if it's false
...
//Batman's theme song is moving to cpp! Create a while loop that prints "nah" while the iterator is less than or equal to 16 (starting at 0), afterwards print "batman!" 
//Make sure there's a space between the nah's and the batman! (e.g. nahnahnah batman!"
string batmanthemesong(int y){
}
...
int main(){
	...
	if(batmanthemesong == "nahnahnahnahnahnahnahnahnahnahnahnahnahnahnahnah batman!") 
